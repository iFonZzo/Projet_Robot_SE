...
extern void Robot_start(){
    ...
    if (robot.mD == NULL) PProseError("ERROR: Problème d'ouverture du moteur droit (port MD)");
    if (robot.mG == NULL) PProseError("ERROR: Problème d'ouverture du moteur gauche (port MA)");
    ...
    if (robot.floorSensor== NULL) PProseError("Problème initialisation floorSensor");
    if (robot.frontSensor== NULL) PProseError("Problème initialisation frontSensor");
    if (robot.lightSensor== NULL) PProseError("Problème initialisation lightSensor");
